...
export const cropsDatabase: CropData[] = [
  ...
  },
  {
    ...
    waterRequirement: 'low',
    plantingPeriod: 'September-October',
    season: 'Rabi',
  ...
  },
  {
    ...
    waterRequirement: 'medium',
    plantingPeriod: 'September-December',
    season: 'Rabi',
    soilType: ['loamy', 'sandy loam'],
    irrigationType: ['drip', 'sprinkler'],
  ...
  },
  {
    ...
    waterRequirement: 'medium',
    plantingPeriod: 'February-April, July-September',
    season: 'Kharif/Rabi',
    soilType: ['loamy', 'sandy loam'],
    irrigationType: ['drip', 'sprinkler'],
