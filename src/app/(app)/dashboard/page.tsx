    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1">
          {isLoading ? (
            <div className="border-t pt-8 lg:border-none lg:pt-0">
            ...
            <>
              <h2 className="text-2xl font-bold tracking-tight font-headline lg:border-t-0 pt-8 lg:pt-0">Your Farms</h2>
              {farms.length === 0 ? (
